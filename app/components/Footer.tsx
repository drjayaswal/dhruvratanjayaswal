...
export default function Footer() {
  ...
  return (
    <footer className="bg-cyan-800 text-white py-4 sm:py-6 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
          <form onSubmit={handleSubmit} className="flex-1 max-w-md flex gap-2 w-full md:w-auto">
            <input
              type="text"
              value={message}
              ...
              placeholder={
                status === "success" 
                  ...
                  : "Any Idea? or Joke? let me hear..."
              }
              disabled={status === "sending"}
              className="flex-1 px-3 sm:px-4 py-2 border border-cyan-700 rounded-full outline-0 focus-visible:ring-0 ring-0 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base disabled:opacity-50"
            />
            <button
              type="submit"
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            <a
              ...
              className="bg-blue-600 hover:bg-blue-700 p-2 sm:p-3 rounded-full transition-all duration-300 hover:scale-110"
              aria-label="LinkedIn"
            >
            ...
            <a
              href="https://github.com/drjayaswal?tab=repositories"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 hover:bg-gray-600 p-2 sm:p-3 rounded-full transition-all duration-300 hover:scale-110"
              aria-label="GitHub"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a
              ...
              className="bg-red-600 hover:bg-red-700 p-2 sm:p-3 rounded-full transition-all duration-300 hover:scale-110"
              aria-label="Email"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 20 20">
